const ollamaUrl = "https://corsproxy.io/?urlhttps://85be-105-156-68-164.ngrok-free.app/api/generate";
...
Réponse: Les horaires d'ouverture sont de 9h à 18h du mardi au dimanche.

Question: Quels sont les tarifs d'entrée?
Réponse: Le tarif d'entrée est de 50 MAD pour les adultes et 25 MAD pour les étudiants.

Question: Où se trouve le musée?
Réponse: Le musée est situé au centre-ville, près de la place principale.
        ...
        if (!foundMuseumEntry || !matched || isImageRequest) {
            ...
            try {
                ...
                if (isImageRequest) {
                    ...
                    // Rediriger vers Google Search pour les images
